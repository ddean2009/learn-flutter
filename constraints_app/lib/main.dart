...
class Example2 extends Example {
  ...
  @override
  final code = 'Container(width: 100, height: 100, color: blue)';
  @override
  final String explanation =
      'The blue Container wants to be 100x100, but it can\'t, '
...
class Example5 extends Example {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Container(
          width: double.infinity, height: double.infinity, color: blue),
    );
  }
}
...
class Example6 extends Example {
  ...
  @override
  final code = 'Center(child: Container(color: blue))';
  @override
  final String explanation =
      'The screen forces the Center to be exactly the same size as the screen, '
      'so the Center fills the screen.'
...
class Example7 extends Example {
  ...
  final String explanation =
      ...
      'so the Center fills the screen.'
      '\n\n'
      'The Center tells the blue Container that it can be any size it wants, but not bigger than the screen.'
      'Since the blue Container has no size but has a child, it decides it wants to be the same size as its child.'
      '\n\n'
      'The blue Container tells its child that it can be any size it wants, but not bigger than the screen.'
      '\n\n'
      'The child is a green Container that wants to be 30x30.'
      '\n\n'
      'Since the blue `Container` has no size but has a child, it decides it wants to be the same size as its child. '
      'The blue color isn\'t visible, since the green Container entirely covers all of the blue Container.';
...
class Example8 extends Example {
  ...
  @override
  final String explanation =
      'The blue Container sizes itself to its children size, but it takes its own padding into consideration. '
      'So it is also 30x30 plus padding. '
      'The blue color is visible because of the padding, and the green Container has the same size as in the previous example.';
...
class Example11 extends Example {
  ...
  final code = 'Center(\n'
      ...
      '                 minWidth: 70, minHeight: 70,\n'
      '                 maxWidth: 150, maxHeight: 150),\n'
      '        child: Container(color: blue, width: 1000, height: 1000))))';
  @override
  final String explanation =
...
class Example12 extends Example {
  ...
  final code = 'Center(\n'
      ...
      '                 minWidth: 70, minHeight: 70,\n'
      '                 maxWidth: 150, maxHeight: 150),\n'
      '        child: Container(color: blue, width: 100, height: 100))))';
  @override
  final String explanation =
      'Center allows ConstrainedBox to be any size up to the screen size.'
...
class Example13 extends Example {
  ...
  final code = 'UnconstrainedBox(\n'
      '   child: Container(color: blue, width: 20, height: 50));';
  @override
  final String explanation =
...
class Example14 extends Example {
  ...
  @override
  final code = 'UnconstrainedBox(\n'
      '   child: Container(color: blue, width: 4000, height: 50));';
  @override
  final String explanation =
      'The screen forces the UnconstrainedBox to be exactly the same size as the screen, '
...
class Example23 extends Example {
  ...
  final code = 'Row(children:[\n'
      '   Container(color: blue, child: Text(\'Hello!\'))\n'
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        Container(color: blue, child: const Text('Hello!', style: big)),
...
class Example24 extends Example {
  ...
  @override
  final code = 'Row(children:[\n'
      '   Container(color: blue, child: Text(\'…\'))\n'
      '   Container(color: green, child: Text(\'Goodbye!\'))]';
  @override
  final String explanation =
...
class Example25 extends Example {
  ...
  final code = 'Row(children:[\n'
      '   Expanded(\n'
      '       child: Container(color: blue, child: Text(\'…\')))\n'
      '   Container(color: green, child: Text(\'Goodbye!\'))]';
  @override
  final String explanation =
      ...
      '\n\n'
      'In other words, once you use Expanded, the original child\'s width becomes irrelevant, and is ignoblue.';
...
class Example26 extends Example {
  ...
  final String explanation =
      ...
      '\n\n'
      'In other words, Expanded ignores the preffeblue width of its children.';
